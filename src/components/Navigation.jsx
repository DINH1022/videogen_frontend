...
const Navigation = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      rafId.current = requestAnimationFrame(() => {
        ...
        // Tăng khoảng cách để làm chậm hiệu ứng
        const maxScroll = 2000; // Tăng từ 1000 lên 2000 để chậm hơn
        const fadeStartPoint = 200; // Tăng từ 100 lên 200

        // Thêm easing function để làm mượt hơn
        ...
        if (scrollTop <= fadeStartPoint) {
          ...
          // Tính toán opacity với easing function
          ...
          // Áp dụng easing function để làm mượt
  ...
  const getAppBarBackground = () => {
    ...
    return "linear-gradient(135deg, rgba(102, 126, 234, 0.95) 0%, rgba(118, 75, 162, 0.95) 50%, rgba(255, 107, 157, 0.95) 100%)";
  };
        ...
        {!isLoggedIn ? (
          <Button
            ...
            sx={{
              ...
              border: "1px solid rgba(255, 255, 255, 0.3)",
              "&:hover": {
                background: "linear-gradient(135deg, #e55a87 0%, #d678d8 100%)",
                transform: "translateY(-2px)",
                boxShadow: "0 8px 25px rgba(255, 107, 157, 0.4)",
              },
              transition: "all 0.3s ease",
  ...
  return (
    <>
      <AppBar
        ...
        elevation={0}
        sx={{
          borderRadius: isHomePage ? "0" : "0 0 20px 20px",
          background: getAppBarBackground(),
          backdropFilter: "blur(20px)",
          border: "none",
          color: "white",
          opacity: isHomePage ? scrollOpacity : 1,
          // Cải thiện transition để mượt hơn
          transition: "all 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94)", // Thay đổi từ 0.3s thành 0.6s và dùng easing mượt hơn
              ...
              <Box
                sx={{
                  ...
                  background: isHomePage
                    ? "rgba(255, 255, 255, 0.9)"
                    : "linear-gradient(135deg, rgba(102, 126, 234, 0.3) 0%, rgba(255, 107, 157, 0.3) 100%)",
                  backdropFilter: "blur(10px)",
                  border: isHomePage
                    ? "1px solid rgba(102, 126, 234, 0.2)"
                      ...
                      sx={{
                        ...
                        background: item.featured
                          ? isHomePage
                            ...
                            : "linear-gradient(135deg, rgba(255, 107, 157, 0.3) 0%, rgba(240, 147, 251, 0.3) 100%)"
                          : isHomePage
                          ? "rgba(255, 255, 255, 0.9)"
                        ...
                        "&:hover": {
                          background: item.featured
                            ? isHomePage
                              ? "rgba(255, 107, 157, 1)"
                              : "linear-gradient(135deg, rgba(255, 107, 157, 0.4) 0%, rgba(240, 147, 251, 0.4) 100%)"
                            : isHomePage
                            ? "rgba(255, 255, 255, 1)"
              ...
              {!isLoggedIn ? (
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      background:
                        "linear-gradient(135deg, #e55a87 0%, #d678d8 100%)",
                      transform: "translateY(-2px)",
                      boxShadow: "0 8px 25px rgba(255, 107, 157, 0.4)",
                    },
                  }}
