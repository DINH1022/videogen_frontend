...
const VideoCard = ({ video, isPublishedTab }) => {
  ...
  // Xử lý khi click "Xem trên" - mở tab mới
  ...
  const handleDownloadVideo = async () => {
    if (video.url) {
      try {
        ...
        link.href = url;
        link.download = `${video.topic || "video"}.mp4`; // Tên file download
        ...
        // Fallback: mở video trong tab mới nếu không thể download
